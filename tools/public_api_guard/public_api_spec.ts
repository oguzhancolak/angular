...
const CORE = [
  ...
  'IterableDiffers.find(iterable:Object):IterableDifferFactory',
  'Key',
  ...
  'Renderer.listen(renderElement:any, name:string, callback:Function):any',
